              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _bulletPoint('Coast-Down: coast a hill with no pedalling.'),
                    _bulletPoint('Constant Power: ride flat road at steady wattage.'),
                    _bulletPoint('Lap Efficiency: ride a closed loop and compare laps.'),
                    const SizedBox(height: 24),
                    _sectionHeader('Step 2 — Perform 3+ runs'),
                    _bulletPoint('Each run must use a different tire pressure.'),
                    _bulletPoint('Start high (max rated), then low (min rated), then mid-range.'),
                    _bulletPoint('Minimum three runs are required to calculate an optimum.'),
                    const SizedBox(height: 24),
                    _sectionHeader('Step 3 — Get your perfect pressure'),
                    _bulletPoint('The app fits a curve to your results.'),
                    _bulletPoint('The vertex of the curve is your optimal pressure.'),
                    const SizedBox(height: 24),
                    _sectionHeader('Before you start'),
                    _bulletPoint('Set up your wheel metrics and bike type.'),
                    _bulletPoint('Pair your speed and power sensors.'),
                    _bulletPoint('This setup only takes a minute and is saved for future sessions.'),
